drop table if exists test_order1;
drop table if exists random_source1;
drop table if exists random_source_store1;
...
create table random_source_store1(
                            id bigint not null,
                            id1 bigint,
                            id2 bigint,
                            id3 bigint,
